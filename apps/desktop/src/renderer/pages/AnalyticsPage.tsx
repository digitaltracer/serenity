              ...
              {!showAdvanced ? (
                <div className="text-center py-8">
                  <div className="text-gray-500 dark:text-gray-400 mb-4">
                    Click "Show Details" to view advanced analytics including charts, trends, AI insights, and project insights.
                  </div>
                  <div className="text-sm text-gray-400 dark:text-gray-500">
                    Interactive charts • Performance trends • AI-powered insights
                  </div>
                </div>
              ) : (
                <AdvancedAnalytics 
