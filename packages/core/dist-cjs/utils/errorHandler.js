...
exports.ErrorHandler = exports.ERROR_CODES = exports.ErrorCategory = exports.ErrorSeverity = void 0;
exports.throwAuthError = throwAuthError;
exports.throwDatabaseError = throwDatabaseError;
exports.throwEncryptionError = throwEncryptionError;
exports.throwIntegrationError = throwIntegrationError;
...
class ErrorHandler {
    ...
    static createError(codeKey, originalError, context, customUserMessage) {
        const errorDef = exports.ERROR_CODES[codeKey];
        const error = {
            name: 'SerenityError',
            code: errorDef.code,
    ...
    static logError(error) {
        ...
        switch (error.severity) {
            case ErrorSeverity.CRITICAL:
                logger_1.logger.error(`🚨 CRITICAL - ${message}`, logContext, error.originalError);
                break;
            case ErrorSeverity.HIGH:
                logger_1.logger.error(`❌ ERROR - ${message}`, logContext, error.originalError);
                break;
            case ErrorSeverity.MEDIUM:
                logger_1.logger.warn(`⚠️ WARNING - ${message}`, logContext);
                break;
            case ErrorSeverity.LOW:
                logger_1.logger.info(`ℹ️ INFO - ${message}`, logContext);
                break;
        }
    }
    /**
 ...
 */
function throwAuthError(code, originalError, context) {
    throw ErrorHandler.handle(ErrorHandler.createError(code, originalError, context));
}
/**
 * Create and throw a database error
 */
function throwDatabaseError(code, originalError, context) {
    throw ErrorHandler.handle(ErrorHandler.createError(code, originalError, context));
}
/**
 * Create and throw an encryption error
 */
function throwEncryptionError(code, originalError, context) {
    throw ErrorHandler.handle(ErrorHandler.createError(code, originalError, context));
}
/**
 * Create and throw an integration error
 */
function throwIntegrationError(code, originalError, context) {
    throw ErrorHandler.handle(ErrorHandler.createError(code, originalError, context));
}
/**
 * Create and throw a validation error
 */
function throwValidationError(code, originalError, context) {
    throw ErrorHandler.handle(ErrorHandler.createError(code, originalError, context));
}
/**
