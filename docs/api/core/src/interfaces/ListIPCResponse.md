...
[serenity-notes](../../../README.md) / [core/src](../README.md) / ListIPCResponse

# Interface: ListIPCResponse\<T\>

Defined in: [packages/core/src/types/ipc.ts:66](https://github.com/digitaltracer/serenity/blob/improv/code-improvements/packages/core/src/types/ipc.ts#L66)
...
Defined in: [packages/core/src/types/ipc.ts:67](https://github.com/digitaltracer/serenity/blob/improv/code-improvements/packages/core/src/types/ipc.ts#L67)
