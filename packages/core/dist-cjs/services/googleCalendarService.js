...
class GoogleCalendarService {
     ...
     */
    static async getCalendarList(accessToken) {
...
GoogleCalendarService.CLIENT_ID = process.env.GOOGLE_CLIENT_ID || '';
GoogleCalendarService.CLIENT_SECRET = process.env.GOOGLE_CLIENT_SECRET || '';
GoogleCalendarService.REDIRECT_URI = 'http://localhost:3000/auth/google/callback';
GoogleCalendarService.SCOPES = 'https://www.googleapis.com/auth/calendar.readonly';
