...
exports.getShortcutConflicts = exports.shouldIgnoreShortcuts = exports.findShortcutById = exports.getGlobalShortcuts = exports.getEnabledShortcuts = exports.getShortcutsByCategory = exports.matchesShortcut = exports.formatShortcut = exports.isMac = exports.DEFAULT_SHORTCUTS = void 0;
 ...
 */
const getShortcutsByCategory = (shortcuts, category) => {
 ...
 */
const getEnabledShortcuts = (shortcuts) => {
    return shortcuts.filter(shortcut => shortcut.enabled);
};
exports.getEnabledShortcuts = getEnabledShortcuts;
/**
 * Get global shortcuts (available in all contexts)
 */
const getGlobalShortcuts = (shortcuts) => {
 ...
 * Find shortcut by ID
 */
const findShortcutById = (shortcuts, id) => {
    return shortcuts.find(shortcut => shortcut.id === id);
};
exports.findShortcutById = findShortcutById;
/**
...
exports.shouldIgnoreShortcuts = shouldIgnoreShortcuts;
/**
 * Get shortcut conflicts (same key combination)
 */
const getShortcutConflicts = (shortcuts) => {
    const conflicts = [];
    const processed = new Set();
    for (const shortcut of shortcuts) {
        if (processed.has(shortcut.id))
            continue;
        const conflicting = shortcuts.filter(s => s.id !== shortcut.id &&
            s.key === shortcut.key &&
...
exports.getShortcutConflicts = getShortcutConflicts;
