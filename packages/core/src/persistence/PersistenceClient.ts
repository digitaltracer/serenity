...
let persistenceClientSingleton: PersistenceClient | null = null;

export function setPersistenceClient(client: PersistenceClient): void {
  persistenceClientSingleton = client;
}

export function getPersistenceClient(): PersistenceClient {
