...
exports.DEFAULT_CLASSIFICATION = {
...
class EncryptionService {
    ...
    static async encrypt(data, password, classification = 'confidential', keyVersion) {
        ...
        try {
            ...
            (0, errorHandler_1.throwEncryptionError)('CRYPTO_ENCRYPTION_FAILED', error instanceof Error ? error : new Error(String(error)), { classification, keyVersion });
        }
    }
    /**
    ...
    static async decrypt(encryptedData, password, classification = 'confidential') {
        ...
        try {
            ...
            (0, errorHandler_1.throwEncryptionError)('CRYPTO_DECRYPTION_FAILED', error instanceof Error ? error : new Error(String(error)), { classification });
        }
    }
    /**
...
class KeyRotationManager {
    constructor(config = exports.DEFAULT_KEY_ROTATION) {
        this.config = { ...config };
...
class DataClassificationManager {
    constructor(settings = exports.DEFAULT_CLASSIFICATION) {
...
exports.DataClassificationManager = DataClassificationManager;
