...
import { selectTodayTasks, toggleTask } from '@serenity/core'
        ...
        <Card>
          ...
          <CardContent>
            <div className="flex items-center gap-2 text-blue-600 dark:text-blue-400">
              ...
              <span className="font-medium">{todayTasks.length} tasks planned</span>
            </div>
            <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
              {todayTasks.filter(t => !t.completed).length} tasks left to complete
            </p>
          </CardContent>
        </Card>
      </div>
