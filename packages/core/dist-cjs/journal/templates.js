...
exports.getTemplatesByTags = exports.getTemplateById = exports.journalTemplates = void 0;
exports.journalTemplates = [
    {
        id: 'daily-reflection',
...
const getTemplateById = (id) => {
    return exports.journalTemplates.find(template => template.id === id);
};
exports.getTemplateById = getTemplateById;
const getTemplatesByTags = (tags) => {
    return exports.journalTemplates.filter(template => template.tags.some(tag => tags.includes(tag)));
};
exports.getTemplatesByTags = getTemplatesByTags;
