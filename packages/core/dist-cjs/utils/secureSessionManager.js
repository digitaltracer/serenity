...
exports.secureSessionManager = exports.SecureSessionManager = void 0;
class SecureSessionManager {
    constructor() {
        this.masterPassword = null;
        this.sessionStartTime = null;
        this.sessionTimeout = 15 * 60 * 1000; // 15 minutes default
...
exports.secureSessionManager = SecureSessionManager.getInstance();
